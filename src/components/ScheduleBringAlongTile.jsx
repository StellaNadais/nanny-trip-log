...
export default function ScheduleBringAlongTile({ bookings }) {
  ...
  if (!nextBooking) {
    return (
      <section
        className="schedule-bring-along schedule-bring-along--empty schedule-bring-along--unavailable"
        aria-label="Bring with me"
        aria-describedby="schedule-bring-along-unavailable"
        aria-disabled="true"
      >
        <div className="schedule-bring-along__content">
        ...
        <p id="schedule-bring-along-unavailable" className="schedule-bring-along__availability">
          Not available yet
        </p>
      </section>
    )
  ...
  return (
    <section
      className="schedule-bring-along schedule-bring-along--unavailable"
      aria-label="Bring with me"
      aria-describedby="schedule-bring-along-unavailable"
      aria-disabled="true"
    >
